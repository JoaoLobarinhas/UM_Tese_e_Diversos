...
input_file = '/home/joaolobarinhasfm/Aux_Repo/Community-Detection-Algorithm-master/network_real_9.txt'
output_file = '/home/joaolobarinhasfm/Aux_Repo/Vulnerability-Metrics-master/TS_network_real_9.txt'

print(f"Started...{str(datetime.datetime.now())}")
...
with open(output_file, 'w') as f:
   for i in vertices:
        f.write('{0} {1} {2}\n'.format(i, norm_hti[i], norm_htw[i]))
